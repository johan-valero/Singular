<?php $this->view("header", $data); ?>
    <!-- Header Banner -->
    <div class="banner-header section-padding valign bg-img bg-fixed" data-overlay-dark="3" data-background="<?=ASSETS?>img/pages/mountain2.jpg" style="background-position:center;">
        <div class="container">
            <div class="row">
